...
<PageWrapper key="page1">
  <div className="px-4 sm:px-6 md:px-8 py-10 text-center max-w-3xl mx-auto">
    <motion.h1
      className="text-2xl sm:text-3xl md:text-4xl font-bold text-pink-600 mb-4"
    ...
    <motion.p
      ...
      transition={{ delay: 1 }}
    >
      You are not just my love, you are my heart, my soul, my everything.
      Happy birthday to the man who completes me.
      Every moment with you feels like a fairytale.
      Thank you for making reality more beautiful than dreams.
      You're the light of my life, my heart, my everything.
    ...
    src="data:image/jpeg;base64," // Replace with real URL
      alt="Dodo Bobo"
      className="mx-auto mt-6 w-28 sm:w-36 md:w-48 rounded-xl shadow-lg"
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
    ...
    <motion.div
      className="mt-6 text-pink-700 text-sm sm:text-base md:text-lg font-medium"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
,
  ...
  <div className="px-4 sm:px-6 md:px-8 py-10 text-center max-w-3xl mx-auto">
    ...
    >
      ...
      On your birthday, I wish you all the happiness you bring to me daily — and more.
      You deserve it all, my prince.
    </motion.p>
    ...
    <motion.img
      ...
      alt="Cute Love Gif"
      className="mx-auto w-40 sm:w-52 md:w-64 rounded-xl mb-6 shadow-lg"
      initial={{ scale: 0 }}
      animate={{ scale: 1 }}
    ...
    <motion.div
      className="text-base sm:text-lg md:text-xl text-pink-700 font-medium"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ delay: 2 }}
    >
...
,
  ...
  <div className="mt-8 sm:mt-12 text-center px-3 sm:px-6 p-8">
    <motion.h1
      className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-pink-700 mb-6"
      initial={{ opacity: 0, y: -40 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 1 }}
    >
    ...
    <motion.p
      className="text-base sm:text-lg md:text-xl text-gray-700 mb-6 leading-relaxed max-w-2xl mx-auto"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    <motion.img
      ...
      alt="Heart gif"
      className="mx-auto w-40 sm:w-52 md:w-60 rounded-xl shadow-xl"
      initial={{ scale: 0 }}
      animate={{ scale: 1 }}
      transition={{ delay: 1 }}
    />
    ...
    <motion.div
      className="mt-6 sm:mt-8 text-pink-800 text-base sm:text-lg font-semibold"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
,
  ...
  <div className="mt-16 sm:mt-20 px-4 sm:px-6 pb-24 sm:pb-32">
    <motion.h2
      className="text-2xl sm:text-3xl md:text-4xl font-bold text-pink-600 mb-6 text-center"
    ...
    <div className="space-y-4 w-full max-w-md sm:max-w-lg md:max-w-xl mx-auto">
      {reasons.map((reason, index) => (
        ...
        >
          <button
            ...
            className="w-full text-left px-4 py-3 sm:px-5 sm:py-4 bg-pink-100 hover:bg-pink-200 font-medium text-gray-800 text-base sm:text-lg transition-colors duration-200"
          >
            ❤️ {index + 1}
          </button>
          ...
          <AnimatePresence initial={false}>
            {openIndex === index && (
              <motion.div
                ...
                className="overflow-hidden px-4 py-2 sm:px-5 sm:py-3 bg-pink-50 text-gray-700 text-sm sm:text-base"
              >
                <div>{reason}</div>
              </motion.div>
            )}
...
,
  ...
  <div className="flex flex-col items-center justify-center text-center px-4 sm:px-6 py-10 min-h-[80vh] bg-pink-50">
    <motion.h2
      className="text-2xl sm:text-3xl md:text-4xl font-bold text-pink-600 mb-6"
      initial={{ opacity: 0, y: -30 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6 }}
    >
    ...
    {!isUnwrapped ? (
      <motion.img
        ...
        alt="Gift box"
        className="w-28 sm:w-40 md:w-48 cursor-pointer drop-shadow-lg"
      ...
      <motion.div
        className="mt-6 bg-pink-100 p-4 sm:p-6 rounded-xl shadow-lg max-w-md w-full"
        initial={{ scale: 0.5, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ type: "spring", stiffness: 120 }}
      >
        <motion.h3
          className="text-xl sm:text-2xl font-semibold text-pink-700 mb-4"
        ...
        <motion.p
          className="text-base sm:text-lg text-gray-800 mb-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.8 }}
        >
        ...
        <motion.img
          ...
          alt="Surprise"
          className="w-40 sm:w-60 mx-auto rounded-lg shadow-md"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ delay: 1 }}
        />
...
,
  ...
  <div className="flex flex-col items-center justify-center text-center space-y-6 px-4 sm:px-6 py-10 min-h-[80vh] bg-pink-50">
    <motion.h2
    ...
    {!showHug ? (
      <motion.button
        ...
        className="bg-pink-500 text-white text-base sm:text-lg px-6 py-3 rounded-full shadow-md hover:bg-pink-600 transition-all"
        whileHover={{ scale: 1.1 }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <motion.img
          ...
          alt="Teddy bear hug"
          className="w-40 sm:w-64 rounded-xl shadow-xl"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        <motion.p
          className="text-base sm:text-lg text-pink-700 font-medium"
  ...
  <div className="w-full min-h-[80vh] sm:min-h-[85vh] bg-pink-50 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-10">
    <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8 max-w-xl sm:max-w-2xl w-full border border-pink-200">
      <motion.h2
        className="text-2xl sm:text-3xl md:text-4xl text-pink-600 font-bold mb-4 sm:mb-6 text-center"
      ...
      <motion.p
        className="text-base sm:text-lg text-gray-800 leading-relaxed font-[Great Vibes] italic text-[1.2rem] sm:text-[1.5rem]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
